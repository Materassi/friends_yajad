...
(function () {
  ...
  var EN = {
    ...
    "g.nav.cta":"Donate on GoFundMe ↗",
    "g.eyebrow":"Official campaign · GoFundMe",
    "g.h1":"Support us on <span class=\"accent\">GoFundMe</span> and help rebuild our community.",
    "g.lede":"After the June 24, 2026 earthquake, the Vaad of Venezuela opened an official GoFundMe campaign for the benefit of Friends of Yajad-Venezuela. Every gift funds shelter, food, housing, and the recovery of hundreds of families.",
    "g.cta":"Donate on GoFundMe ↗",
    "g.cta2":"Give directly",
    "g.trust":"Administered by Friends of Yajad-Venezuela, a 501(c)(3). Tax-deductible. EIN <span class=\"ein-num\"></span>",
    "g.goal.tag":"GoFundMe campaign",
    "g.goal.org":"Organized by the Vaad of Venezuela · Beneficiary: Friends of Yajad-Venezuela",
    "g.goal.label":"Campaign goal",
    "g.goal.cta":"Donate now on GoFundMe ↗",
    "g.goal.note":"Opens on GoFundMe, in a new tab.",
    "g.use.eyebrow":"What your donation supports",
    "g.use.h2":"What your gift makes possible",
    "g.use.p":"Funds go exclusively to emergency relief, humanitarian assistance, and the recovery of the community's families.",
    "g.use1.t":"Emergency shelters","g.use1.d":"Running shelters and humanitarian assistance for displaced families.",
    "g.use2.t":"Rest & warmth","g.use2.d":"Mattresses, cots, blankets, sheets, and essential bedding.",
    "g.use3.t":"Food & water","g.use3.d":"Kosher food, bottled water, and emergency meals.",
    "g.use4.t":"Health & hygiene","g.use4.d":"Medical supplies, first aid, hygiene kits, and basic necessities.",
    "g.use5.t":"Housing & repairs","g.use5.d":"Temporary housing, rental assistance, and grants to repair damaged homes.",
    "g.use6.t":"Children & school","g.use6.d":"Tuition assistance, school meals, and educational support for affected children.",
    "g.trust.eyebrow":"Why you can trust it",
    "g.trust.h2":"One community, two ways to help",
    "g.trust.p":"The GoFundMe campaign is organized by the Vaad of Venezuela and all funds are administered through Friends of Yajad-Venezuela, our U.S. 501(c)(3). You get GoFundMe's protection and support, and your gift is tax-deductible.",
    "g.trust.quote":"\u201cDo not separate yourself from the community\u201d — Hillel, Pirkei Avot 2:4",
    "g.trust.cta":"Go to the campaign ↗",
    "g.trust.cta2":"I'd rather give directly",
    "g.s1":"GoFundMe campaign goal",
    "g.s2":"Tax-deductible · EIN <span class=\"ein-num\"></span>",
    "g.s3":"To assistance for the Jewish Community of Venezuela",
    "g.s4":"Earthquake that left hundreds of families homeless",
    "g.final.h2":"Every gift, large or small, makes a difference",
    "g.final.p":"Thank you for standing with the Jewish Community of Venezuela in one of the most difficult moments in its history.",
    "g.final.cta":"Donate on GoFundMe ↗",
    "g.final.cta2":"Give directly on the site",
